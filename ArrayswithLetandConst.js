...
condiments to be a new array that contains a single string ['Mayo']
Log the result to the console.
Notice that you can re-assign 
elements in an array and re-assign an 
entire new array to a variable declared using the let keyword.*/

condiments = ['Mayo']
console.log(condiments);

/*Below your code from Step 2, re-assign the 
last item from the utensils array to 'Spoon'.
